    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
        {sortedEntries.length >= 3 ? (
          ...
          <>
            {/* Rank 2 Slot - Empty White Box */}
            <div className="bg-white rounded-3xl p-5 border-2 border-stone-200/80 shadow-xs order-2 md:order-1 h-56 sm:h-64" />
            {/* Rank 1 Slot - Empty White Box */}
            <div className="bg-gradient-to-b from-amber-50/40 to-white rounded-3xl p-6 border-2 border-amber-300/80 shadow-sm order-1 md:order-2 transform md:-translate-y-4 h-64 sm:h-72" />
            {/* Rank 3 Slot - Empty White Box */}
            <div className="bg-white rounded-3xl p-5 border-2 border-stone-200/80 shadow-xs order-3 h-56 sm:h-64" />
          </>
        )}
      </div>

      {/* Full Leaderboard Table */}
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200 shadow-xs min-h-[280px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Student Badges */}
        <div className="bg-white rounded-3xl p-6 sm:p-7 border border-stone-200 shadow-xs min-h-[220px]">
          {sortedEntries.length > 0 && currentStudent && (
            <div className="space-y-4">
